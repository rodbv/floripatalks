...
# Create resource group (Brazil South region for Brazilian users)
az group create --name floripatalks-rg --location brazilsouth

# Create App Service Plan (Free tier, Brazil South region)
...
# Create Web App (Brazil South region)
az webapp create \
...
**Why**: Prevents direct access to your App Service, forcing all traffic through Cloudflare

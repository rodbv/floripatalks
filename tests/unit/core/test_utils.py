...
class TestFormatNumberPtBr:
    ...
    def test_format_two_digits(self) -> None:
        assert format_number_pt_br(42) == "42"

    def test_format_three_digits(self) -> None:
        assert format_number_pt_br(567) == "567"

    def test_format_four_digits(self) -> None:
        assert format_number_pt_br(1234) == "1.234"

    def test_format_five_digits(self) -> None:
        assert format_number_pt_br(12345) == "12.345"

    def test_format_six_digits(self) -> None:
        assert format_number_pt_br(123456) == "123.456"

    def test_format_seven_digits(self) -> None:
...
class TestFormatVoteCount:
    ...
    def test_format_zero_votes(self) -> None:
        assert format_vote_count(0) == "0 votos"

    def test_format_one_vote(self) -> None:
        assert format_vote_count(1) == "1 voto"

    def test_format_two_votes(self) -> None:
        assert format_vote_count(2) == "2 votos"

    def test_format_many_votes(self) -> None:
        assert format_vote_count(1234) == "1.234 votos"

    def test_format_large_vote_count(self) -> None:
...
class TestFormatCommentCount:
    ...
    def test_format_zero_comments(self) -> None:
        assert format_comment_count(0) == "0 comentários"

    def test_format_one_comment(self) -> None:
        assert format_comment_count(1) == "1 comentário"

    def test_format_two_comments(self) -> None:
        assert format_comment_count(2) == "2 comentários"

    def test_format_many_comments(self) -> None:
        assert format_comment_count(567) == "567 comentários"

    def test_format_large_comment_count(self) -> None:
